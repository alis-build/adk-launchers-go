...
func NewRequestInterceptor() (*RequestInterceptor, error) {
	...
	p, err := plugin.New(plugin.Config{
		...
		BeforeModelCallback: func(ctx agent.Context, llmRequest *model.LLMRequest) (*model.LLMResponse, error) {
		...
		AfterModelCallback: func(ctx agent.Context, llmResponse *model.LLMResponse, _ error) (*model.LLMResponse, error) {
